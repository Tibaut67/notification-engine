/*
 * ROLE: The Notification Business Logic Manager
 * WHAT IT DOES: Enforces the core rule: "You cannot send a notification to a
 * user who doesn't exist." Checks if the user is real, sets status to "PENDING",
 * and tells the repository to save.
 */
